...
//  var fieldButton: ListBuffer[Button] = initFieldArea(player1.board.bounds._1,player1.board.bounds._2)
  var attackSection: AttackSection = new AttackSection(opponent.board.bounds._1,opponent.board.bounds._2)
  var fieldSection: FieldSection = new FieldSection(player1.board.bounds._1,player1.board.bounds._1)
